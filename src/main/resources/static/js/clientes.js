...
// document.getElementById("searchTypeForm").addEventListener("input", (e) => {
//     e.preventDefault();
//     const searchTermInput = document.getElementById("searchTerm");
//     const searchTypes = Array.from(document.getElementsByName("searchType"));
//     searchTypes.some(type => {
//         if (type.checked == true && type.value == "fechaNacimiento") {
...
document.getElementById("search").addEventListener("submit", (e) => {
    ...
    document.getElementById("column").value = "dni"
...
document.getElementById("orderTableForm").addEventListener("input", (e) => {
    ...
    fetch(`clientes/orderby/${column}/${order}?searchTerm=${searchTermTemp}`)
    .then(clientes => clientes.json())
    .then(clientes => {
        fillRows(clientes)
    })
...
function fillRows(clientes){
    ...
    <tr>
        ...
        <td>${cliente.nacionalidadPais}</td>
        <td>
